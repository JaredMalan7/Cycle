...
class HandleCollisionsAction(Action):
    ...
    def _handle_food_collision(self, cast):
        ...
        # This is so that the snake 1 gets points when eating the food, and the food restarts
        ...
        # This is so that the snake 2 gets points when eating the food, and the food restarts
    ...
    def _handle_segment_collision(self, cast):
        ...
        # This code handles collisions between snakes and eating each other's food, if it happens it's Game Over.
